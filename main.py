...
BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join('python-games1','Grenade+1.mp3'))
BULLET_FIRE_SOUND= pygame.mixer.Sound(os.path.join('python-games1','Gun+Silencer.mp3'))
...
SPACE = pygame.transform.scale( pygame.image.load(os.path.join('python-games1','space.png')),(WIDTH,HEIGHT))
